...
<div>
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            <img class="card-img-top" src="@if($product->product_image) {{asset('storage/products/'. $product->product_image)}} @else https://cdn.pixabay.com/photo/2022/03/23/18/56/beach-7087722_1280.jpg  @endif" alt="Card image cap">
