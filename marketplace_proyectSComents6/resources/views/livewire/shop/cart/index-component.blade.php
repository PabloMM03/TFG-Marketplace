                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                  ...
                                  @foreach ($cart_items->sortBy('id') as $key => $item)
                                    <tr>
                                        <td class="image product-thumbnail"><img class="card-img-top" src="@if($item->product_image) {{asset('storage/products/'. $item->product_image)}} @else {{asset('img/default_product.jpg')}}  @endif" alt="#"></td>
                                        ...
                                        <td class="text-right" data-title="Cart">
                                            <span>{{Cart::session(auth()->id())->get($item->id)->getPriceSum()}} €</span>
                                        </td>
                                        <div class="col-md-1 col-lg-1 col-xl-1 text-end">
                                          <td><a type="button" class="fas fa-times text-muted" wire:click="delete_item({{$item->id}})"><i class="fi-rs-trash"></i></a></td>
                                      </div>                                        
                                    </tr>
                                        ...
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><span class="font-lg">{{Cart::session(auth()->id())->getTotalQuantity()}} productos</span></td>
                                                </tr>
                                                {{-- <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="cart_total_amount"><strong><span class="font-xl fw-900 text-brand">{{Cart::session(auth()->id())->getTotal()}} €</span></strong></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
